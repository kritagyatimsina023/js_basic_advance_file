...
//   console.log(2024 - year);
//   console.log(this); //it will print window object becausearrow function will use this keyword for parent scope which is global this (.i.e is window object ) because arrow function will not get its own this keyword
// };
// calcagearrow(2004);
...
// console.log(demo2.calcage()); // hence this always points to the moethods calling the object here this points to the demo2 object because demo2 method is being called. This keyborad is dynamic
